...
abstract class ArrayUtils {
    /**
     * TestListener whether an array contains one or more string keys
     *
     * @param  mixed $value
    ...
    /**
     * TestListener whether an array contains one or more integer keys
     *
     * @param  mixed $value
     * @param  bool  $allowEmpty    Should an empty array() return true
     * @return bool
    ...
    /**
     * TestListener whether an array contains one or more numeric keys.
     *
    ...
    /**
     * TestListener whether an array is a list
     *
    ...
    /**
     * TestListener whether an array is a hash table.
     *
    ...
    public static function gav($arr, $key, $def = null) {
        if(is_array($arr)){
            ...
            trigger_error('argument arr is not a array');
            return null;
        }
    }
